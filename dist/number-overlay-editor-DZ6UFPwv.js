...
import Q, { useRef as X, useState as xe, useEffect as ve, useLayoutEffect as Fe, useMemo as je } from "react";
import { s as Le } from "./index-B3Khzral.js";
...
function et(e) {
  ...
  var te = f.current ? se(f.current) : void 0, ne = typeof window < "u" ? Fe : ve;
  ne(function() {
    var o = f.current;
