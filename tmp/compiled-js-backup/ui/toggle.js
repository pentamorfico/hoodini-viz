...
function Toggle(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(TogglePrimitive.Root, __assign({ "data-slot": "toggle", className: (0, utils_1.cn)(toggleVariants({ variant: variant, size: size, className: className })) }, props)));
}
