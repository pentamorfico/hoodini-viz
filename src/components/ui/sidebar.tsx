...
function Sidebar({
  ...
  const containerPositionClass = isInset ? 'relative' : 'fixed inset-y-0';
  ...
  return (
    <div
      ...
      {...props}
    >
      {/* Sidebar gap logic remains unchanged */}
      <div
      ...
      <div
        ...
        className={cn(
          `${containerPositionClass} z-10 h-full transition-[left,right,width] duration-200 ease-linear flex`,
          side === "left"
