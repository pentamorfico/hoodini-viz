...
import { Info, Settings, Palette, BookOpen } from "lucide-react"
...
export function AppSidebar({
  ...
  arrowheadHeightDisplay: arrowheadHeightDisplayProp,
  setArrowheadHeightDisplay: setArrowheadHeightDisplayProp,
  geneHeightDisplay: geneHeightDisplayProp,
  setGeneHeightDisplay: setGeneHeightDisplayProp,
  ...
  const [localArrowheadHeightDisplay, setLocalArrowheadHeightDisplay] = useState(DEFAULT_CONFIG.gene.arrowheadHeight);
  const arrowheadHeightDisplay = typeof arrowheadHeightDisplayProp !== 'undefined' ? arrowheadHeightDisplayProp : localArrowheadHeightDisplay;
  const setArrowheadHeightDisplay = typeof setArrowheadHeightDisplayProp === 'function' ? setArrowheadHeightDisplayProp : setLocalArrowheadHeightDisplay;

  const [localGeneHeightDisplay, setLocalGeneHeightDisplay] = useState(DEFAULT_CONFIG.gene.height);
  const geneHeightDisplay = typeof geneHeightDisplayProp !== 'undefined' ? geneHeightDisplayProp : localGeneHeightDisplay;
  const setGeneHeightDisplay = typeof setGeneHeightDisplayProp === 'function' ? setGeneHeightDisplayProp : setLocalGeneHeightDisplay;
  ...
  const [localTreeXScale, setLocalTreeXScale] = useState(DEFAULT_CONFIG.tree.xScalePercent);
