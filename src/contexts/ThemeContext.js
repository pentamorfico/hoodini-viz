...
import { visualizationConfig } from '../config/visualizationConfig.js';
...
export const ThemeProvider = ({ children }) => {
  const [theme, setTheme] = useState(visualizationConfig.theme.mode);
  ...
  const getThemeColors = () => {
    return visualizationConfig.theme[theme];
  };
